  ...
  render() {
    return (
      <header className="header">
        <a href='https://learn.freecodecamp.org/data-visualization/data-visualization-projects/visualize-data-with-a-heat-map' target='_blank'><h2>FCC Visualize Data with a Heat Map</h2></a>
      </header>
    );
  }
}
